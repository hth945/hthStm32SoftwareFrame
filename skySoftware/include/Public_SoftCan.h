...
#define BUS_CFL2    	16 //新镜头
#define BUS_CE48KEY	    17 //ce48按键板
#define BUS_CE48C8T6    18 //ce48FPAGc8t6
#define BUS_DHCP        19 //自动分配ID总通信板
#define BUS_SD250       20 //时钟模块
#define BUS_MC_100      21 //测屏幕边缘颜色
#define BUS_ML100       22 //测漏光板
#define BUS_BL20        23 //50路背光
#define BUS_BL20MAIN    24 //50路背光核心板
#define BUS_LX          25 //测电感板
#define BUS_CE48CORE    26 //ce48 核心板
#define BUS_3DPOWER     27 //高精度电源模块核心板
#define BUS_SMALLBL     28//高精度背光电流背光板
#define BUS_CE48AMMETER 29 //ce48电表
#define BUS_A30EXP      30 //A30电源板
